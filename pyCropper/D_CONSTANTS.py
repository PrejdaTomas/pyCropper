...
if runConstants.RUNMODE== RunMode.RUN:
	from .C_CLASSES_UTILITY import UserConstants, ControlConstants
...
if runConstants.RUNMODE == RunMode.TEST:
	userConstants       = UserConstants(displayScale=1.0, widthScale=4, heightScale=3)
	...
	userConstants       = UserConstants(	fromFolder=(_args.fromFolder).strip(),
